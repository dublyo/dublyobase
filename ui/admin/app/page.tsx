...
import { RelationPicker, renderRelationCell, useRelationAnchors } from "./components/relation-picker";
import { AccountModal, AuthScreen, PasswordChangeScreen } from "./components/auth";
import { CollectionIcon, CompactTable, EmptyState, FieldTypeGlyph, Info, LabeledInput, PageFooter, RunHistory, SchemaStatusChip, SQLResultTable, StatusPill } from "./components/ui";
import { canSearchField, cleanField, defaultOptionsForType, fieldIsMultiple, fieldMetaSummary, fieldTypeIcon, fieldWithType, formatJSONInput, isRecordFormField, isReservedDataFieldName, isVisibleRecordField, newDefaultField, numberOptionValue, optionValues, optionValuesText, parseRecordDraft, relationDisplayFieldOptions, renderValue, sanitizeEditorHTML, setFieldOption, setNumberFieldOption, setRelationTargetOption, setStringFieldOption, splitOptionValues, stringOptionValue, toDateTimeLocal } from "./lib/fields";
import { buildRelationConstraint, collectionIndexHints, collectionRelationEdges, collectionReverseRelations, expandableRelationFields, linksTo, relationCardinalityLabel, relationCardinalityType, relationConstraintLabel, relationExpandParam, relationJunctionName, relationLabelFor, relationOnDeleteValue, relationReversePlaceholder, relationSecondaryFor, relationStorageLabel, relationTargetName, safeIdentifier, setRelationCardinality, singleRelationFields } from "./lib/relations";
import { collectionIconFromOptions, collectionImportedFromOptions, collectionManagedByDublyobase, collectionOptionsWithIcon, collectionPrimaryKeyFieldName, collectionSourceTable, collectionStandardSystemColumns, defaultCollectionIcon, discoveredTableKey, extractImportItems, isValidCollectionName, normalizeCollectionIcon, normalizeCollectionOptions, pascalCase, recordPrimaryKeyValue, sampleRecordPayload, sampleUpdatePayload, stripSystemFields, schemaImportNameIssues, tableRelationSummary } from "./lib/collections";
import { csvCell, formatSQLValue, isDangerousSQL, loadSQLHistory, saveSQLHistory, sqlResultToCSV } from "./lib/sql";
import { defaultAuthSettingsForProject, quotasToDraft, settingsToCORSDraft, settingsToLogDraft, settingsToSMTPDraft, settingsToStorageDraft, splitDraftList } from "./lib/settings-drafts";
import { collectionIconChoices, collectionIconMap, emptyAdminDraft, emptyAuditFilters, emptyBackupDraft, emptyCORSDraft, emptyCollectionDraft, emptyCronDraft, emptyLogDraft, emptyMCPDraft, emptyQuotaDraft, emptyRequestFilters, emptyRules, emptySMTPDraft, emptyStorageDraft, emptyWebhookDraft, fieldTypeChoices, fieldTypes, insightRanges, navItems, recordPageSizes, reservedDataFieldNames, settingsItems, SQL_HISTORY_KEY, TOKEN_KEY } from "./lib/constants";
import type { CollectionDraft, CollectionModalMode, CollectionsMode, InsightsRangeHours, InsightsTab, Notice, OverviewTab, RelationAnchor, RelationCardinality, RelationConstraint, RelationEdge, RuleDraft, SettingsSection, View } from "./lib/view-types";
import { buildLogBuckets, defaultInsightCollection, findFiles, formatBytes, formatCompactNumber, formatCount, formatDate, formatDurationMs, formatInsightTick, formatPercent, formatTime, parseHeadersJSON } from "./lib/format";
import type { FileMeta } from "./lib/format";
...
function InsightKPI({ label, value, detail, icon: Icon, tone = "default" }: { label: string; value: string; detail?: string; icon?: LucideIcon; tone?: "default" | "success" | "warning" }) {
  return (
